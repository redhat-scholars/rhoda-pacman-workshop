...
== Exercise: Connecting an application to a database instance using the topology view
== Exercise: Exploring RHODA Magic
...
In the Developer Perspective in your `%PROJECT%` project,
...
CAUTION: Make sure you name your database service name *mongodb-pacman*
